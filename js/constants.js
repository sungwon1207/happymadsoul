const contractAddress = "0xe9164D65d82A7d3021e199258E1f526c1E606b93"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to Happy Mad Soul Society!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'HMSS a new media company and makes profits from NFTs, Games, Youtube videos, webtoons and various projects. Please check our promotion video <a href="https://youtu.be/28sEP8ZMeBY"target="_blank" rel="noopener noreferrer">HappyMadSoulSociety</a>YouTube channel.';
